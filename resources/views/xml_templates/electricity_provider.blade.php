<root>
    <content>
        ...
        <provider provider_id="{{ $apz->commission->apzElectricityResponse->user->id }}" type="electricity">
        ...
        <provider_answer response_id="{{ $apz->commission->apzElectricityResponse->id }}" type="electricity">
